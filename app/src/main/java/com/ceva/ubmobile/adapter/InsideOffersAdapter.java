...
public class InsideOffersAdapter extends RecyclerView.Adapter<InsideOffersAdapter.MyViewHolder> implements Filterable {

    private List<DealItem> DealItemList;
    private Context context;
    private List<DealItem> orig;

    public InsideOffersAdapter(List<DealItem> DealItemList, Context context) {
        this.DealItemList = DealItemList;
        this.context = context;
    }

    @Override
    public InsideOffersAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.inside_offers_row, parent, false);

        return new InsideOffersAdapter.MyViewHolder(itemView);
    }

    @Override
    public void onBindViewHolder(final InsideOffersAdapter.MyViewHolder holder, int position) {
