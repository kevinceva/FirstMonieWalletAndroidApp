...
/**
 * Created by brian on 01/05/2017.
 */
...
public class TinyDB {
    ...
    public TinyDB(Context appContext) {
        preferences = UBNApplication.get().getSharedPreferences();
    }
...
//    }
    ...
    public ArrayList<ATMLocation> getListATM(String key) {
        Gson gson = new Gson();

        ArrayList<String> objStrings = getListString(key);
        ArrayList<ATMLocation> objects = new ArrayList<>();

        for (String jObjString : objStrings) {
            ATMLocation value = gson.fromJson(jObjString, ATMLocation.class);
            objects.add(value);
        }
        return objects;
    }
...
//
    ...
    public void putListATM(String key, ArrayList<ATMLocation> objArray) {
        checkForNullKey(key);
        Gson gson = new Gson();
        ArrayList<String> objStrings = new ArrayList<String>();
        for (ATMLocation obj : objArray) {
            objStrings.add(gson.toJson(obj));
        }
        putListString(key, objStrings);
    }
