...
public class BillerCategories extends BaseActivity {
    Context context;
    UBNSession session;
        ...
        recyclerView.addOnItemTouchListener(
                new RecyclerItemClickListener(context, new RecyclerItemClickListener.OnItemClickListener() {
                    ...
                    public void onItemClick(View view, int position) {
                        Intent intent = new Intent(context, Billers.class);
    ...
    private void fetchCategories(String username) {
        ...
        String url = SecurityLayer.genURLCBC("getQuicktellerCategories", params, this);
            ...
            public void onResponse(Call<String> call, Response<String> response) {
                ...
                try {
                    ...
                    if (responsecode.equals("00")) {
                        JSONArray objData = new JSONArray(obj.optString("qtCategorydata"));
                        ...
                        for (int j = 0; j < m; j++) {
                            ...
                            BillerModel biller = new BillerModel(null,
                                    null,
                                    null,
                                    null,
                                    null,
                                    billerDet.optString("name"));
                            //billerList.add(biller);
                            if (!billerDet.optString("name").toLowerCase().contains("airtime")) {
                                billerList.add(biller);
                            }
