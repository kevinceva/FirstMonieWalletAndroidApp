...
public class MarketsSubCategories extends BaseActivity {
    Context context;
    UBNSession session;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        category_name = getIntent().getStringExtra(MarketsModel.KEY_CAT_DESC);
        ...
        recyclerView.addOnItemTouchListener(
                new RecyclerItemClickListener(context, new RecyclerItemClickListener.OnItemClickListener() {
                    ...
                    public void onItemClick(View view, int position) {
                        Intent intent = new Intent(context, LifestyleProducts.class);

                        intent.putExtra(MarketsModel.KEY_CAT_ID, category_id);
                        intent.putExtra(MarketsModel.KEY_SUBCAT_ID, billerList.get(position).getId());

                        startActivity(intent);
                    }
                }));

        fetchSubCategories(session.getUserName(), category_id);
    ...
    private void fetchSubCategories(String username, String categoryID) {
        //@Path("/getbillers/{username}")
        billerList.clear();
        showLoadingProgress();

        String params = username + "/" + categoryID;

        String url = SecurityLayer.genURLCBC("onlineSubCategoryList", params, getApplicationContext());
            ...
            public void onResponse(Call<String> call, Response<String> response) {
                ...
                try {
                    ...
                    if (responsecode.equals("00")) {
                        JSONArray objData = new JSONArray(obj.optString("SUB_CATEGORY_LIST"));
                        ...
                        for (int j = 0; j < m; j++) {
                            ...
                            MarketsModel marketsModel = new MarketsModel(billerDet.optString("SUB_CATEGORY_DESC"), billerDet.optString("SUB_CATEGORY_ID"));
