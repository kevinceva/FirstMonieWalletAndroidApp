...
import com.ceva.ubmobile.adapter.SavedBeneficiaryAdapter;
...
public class SavedBeneficiaryTransfer extends BaseActivity implements View.OnClickListener {
    UBNSession session;
    ...
    SavedBeneficiaryAdapter.MyAdapterListener listener;
    ...
    private SavedBeneficiaryAdapter mAdapter;
    private Context context;
    private ImageButton btnAdd;
    private String accountNumber;


    public SavedBeneficiaryTransfer() {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        listener = new SavedBeneficiaryAdapter.MyAdapterListener() {
            ...
            public void iconTransferOnClick(View v, int position, final Beneficiary beneficiary) {
                ...
                new LovelyStandardDialog(context)
                        ...
                        .setPositiveButton("Proceed", new View.OnClickListener() {
                            @Override
                            public void onClick(View view) {
                                Intent intent = new Intent(SavedBeneficiaryTransfer.this, TransfersControllerActivity.class);
        ...
        mAdapter = new SavedBeneficiaryAdapter(beneficiaryList, this, listener);
        ...
        recyclerView.addOnItemTouchListener(
                new RecyclerItemClickListener(context, new RecyclerItemClickListener.OnItemClickListener() {
                    ...
                    public void onItemClick(View view, int pos) {
                        final Beneficiary beneficiary = (Beneficiary) view.getTag();
                        Log.debug("beneficiaryID " + beneficiary.getBeneficiaryId());
                        Log.debug("beneficiaryType " + beneficiary.getType());
                        Log.debug("beneficiaryBank " + beneficiary.getBankCode());
                        final String destBankCode = beneficiary.getType();
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_add) {
            Intent i = new Intent(SavedBeneficiaryTransfer.this, AddBeneficiary.class);
            startActivity(i);
            return true;
        }
        ...
        call.enqueue(new Callback<String>() {
            ...
            public void onResponse(Call<String> call, Response<String> response) {
                ...
                try {
                    ...
                    mAdapter = new SavedBeneficiaryAdapter(beneficiaryList, getApplicationContext(), listener);
                    RecyclerView.LayoutManager mLayoutManager = new LinearLayoutManager(context);
                    recyclerView.setLayoutManager(mLayoutManager);
                    recyclerView.setItemAnimator(new DefaultItemAnimator());
