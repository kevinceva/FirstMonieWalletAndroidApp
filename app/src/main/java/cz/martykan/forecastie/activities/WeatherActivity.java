...
public class WeatherActivity extends BaseActivity implements LocationListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
       ...
       boolean darkTheme = theme == R.style.AppTheme_NoActionBar;


        // Initiate activity
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_scrolling_weather);
    ...
    class TodayWeatherTask extends GenericRequestTask {
        ...
        protected void onPostExecute(TaskOutput output) {
            ...
            // Update widgets
            AbstractWidgetProvider.updateWidgets(WeatherActivity.this);
            DashClockWeatherExtension.updateDashClock(WeatherActivity.this);
        }
